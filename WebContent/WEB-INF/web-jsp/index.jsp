		...
		<div class="header-top">
			<div class="page-width clearfix">
				<div class="header-top__nav">
					<ul>
						...
						<!-- <li class="item"><a href="shopping.do">周边</a></li> -->
						<li class="item"><a href="shopping.do">商品购买</a>
						<li class="item"><a href="videoFileTop.do">我要投稿</a>
						<li class="item"><a href="forum.do">进入论坛</a></li>
					</ul>
				</div>
			...
			%>
				...
				<div class="header-top__user"
					...
					<div>
						<br> <a href="user_full_information.do" style="color: red">个人信息</a>&nbsp;&nbsp;<a
							href="update_login_password.do" style="color: red">修改密码</a>&nbsp;&nbsp;<a
							href="User_full_information.do" style="color: red">修改头像</a><br>
						<div style="background-color: black">------------------------</div>
						<br> <a href="exect.do" style="margin-left: 23%">切换用户</a>
					</div>

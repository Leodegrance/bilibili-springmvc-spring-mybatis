...
<div class="showall" align="center">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="<%=request.getContextPath()%>${grids.girdsimg}" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h3>${grids.girdsname}</h3>
                        	</div>
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="">${grids.girdsjiage}</a></span>
                        	...
                        	<div class="gcIpt">
                        		...
                        		<span class="Hgt">库存（${grids.girdskucun}）</span>
                        	</div>
                        ...
                        <script type="text/javascript">
                        		$("#lijigoumai").click(function(){
                        			...
                        			if(user!="null"){
                        				var a="confirmorder.do?girdsid=${grids.gridsid}&gridsname=${grids.girdsname}&gridskucun=${grids.girdskucun}&gridsjiage=${grids.girdsjiage}&gridsimg=${grids.girdsimg}"
                        				location.href =  a;
                        			}else{
                        				alert("请登录之后购买");
                        		...
                        		$("#gouwuce").click(function(){
                        			...
                        			if(user!="null"){
                        				var html = "";
                        				var girdsName="${grids.girdsname}";//商品名字
                        				var girdsimg = "${grids.girdsimg}";//商品图片地址
                        				var girdsjiage = "${grids.girdsjiage}";//商品价格
                        				var girdsID = "${grids.gridsid}";//商品ID
                        				
                        					//这里是添加至购物车
                        				$.post("shoppingcart.do",{"userName":user,"girdsName":girdsname,"girdsimg":girdsimg,"girdsjiage":girdsjiage,"girdsID":gridsid},function(test){
                        					var ht=eval("("+test+")");

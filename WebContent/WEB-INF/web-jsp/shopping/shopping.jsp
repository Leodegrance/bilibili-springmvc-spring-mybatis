...
<div style="background-color: #6C89B2;width: 100%;height: 25px">
	<div style="margin-left: 90%;">
			...
			<button class="btn btn-primary ladda-button" data-style="expand-left"
				id="userxinxi" ">
				<span class="ladda-label"><a href="user_full_information.do"
		...
		<div align="left" style="margin-left: 93%;margin-top: 300px;position: fixed; z-index: 999;"><a href="shoppingcart.do" style="color:white;background:red;">查看购物车</a>
			<div>&nbsp;&nbsp;</div>
						...
						<div onclick="location.href='details.html';" class="product-grid fade" style="width: 300px">
							<div class="product-grid-head">
								<ul class="grid-social">
									<li><a class="facebook" href="griddetail.do?girdsid=${gridslist.gridsid}"><span> </span></a></li>
									<li><a class="twitter" href="griddetail.do?girdsid=${gridslist.gridsid}"><span> </span></a></li>
									<li><a class="googlep" href="griddetail.do?girdsid=${gridslist.gridsid}"><span> </span></a></li>
									<div class="clear"> </div>
								</ul>
								
							</div>
							<div class="product-pic">
								<a href="griddetail.do?girdsid=${gridslist.gridsid}"><img width="200px" height="200px" src="<%=request.getContextPath()%>${gridslist.girdsimg}" title="product-name" /></a>
								<p>
								<a href="griddetail.do?girdsid=${gridslist.gridsid}">${gridslist.girdsname}</a>
								<!-- <span>Men's Firm-Ground Football Boot</span> -->
								</p>
							</div>
							<div class="product-info">
								<div class="product-info-cust">
									<a href="griddetail.do?girdsid=${gridslist.gridsid}">价格</a>
								</div>
								<div class="product-info-price">
									<a href="griddetail.do?girdsid=${gridslist.gridsid}">${gridslist.girdsjiage}</a>
								</div>
								<div class="clear"> </div>
							</div>

...
<body>
    ...
    <script type="text/javascript">
    		...
    		$("#wangjipassword").click(function(){
    			location.href = "update_paypassword.do";
    		});
    		...
    		$("#zhifu").click(function(){
    			...
    			if(pass==""||pass=="null"){
    				...
    				jQuery.post("yanzhengpass.do",{"pass":pass,"zong":zong,"shangpingmingzi":shangpingmingzi,"shangpingtupiao":shangpingtupiao,"dizhi":dizhi},function(test){
    					var ht=eval("("+test+")");
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.post("querendingdan1.do",function(test){
			var ht=eval("("+test+")");
...
<h3>确认收货地址
 ...
 <a href="delivery_address.do" target="_blank" title="管理我的收货地址"
 class="J_MakePoint" data-point-url="delivery_address.do">修改收货地址</a>
 </span>
</h3>
<ul id="address-list" class="address-list">
 ...
 <span class="marker-tip">寄送至</span>
   <div class="address-info">
 	<a href="#" class="J_Modify modify J_MakePoint" data-point-url="delivery_address.do">修改本地址</a>
 	<input name="address"
 	class="J_MakePoint "
 	type="radio"
	 value="674944241"
 	id="addrId_674944241"
 	data-point-url="delivery_address.do"

				...
				<div id="threadlist" class="btr bbr tl bm bmw trans-80">
					...
					<c:forEach items="${list}" var="list">
								<tbody id="normalthread_555837">
									<tr>
										<td class="icn"><a href="forumReply.do?forumid=${list.forumid}" title="有新回复 - 新窗口打开"
										...
										<th class="new"><a class="tdpre y"
											...
											<a href="forumReply.do?forumID=${list.forumid}" onclick="atarget(this)" class="s xst">${list.forumbt }</a> <span class="tps">&nbsp;<a
												href="forumReply.do?forumID=${list.forumid}"></a></span></th>
										<td class="by"><cite> <a href="forumReply.do?forumID=${list.forumid}" c="1"
								...
								$("#butt").click(function(){
										...
										if(admin=="null"){
											...
											if(biaoti==null||biaoti==""||neirong==null||neirong==""){
												...
												var html= "";
												//将得到的使用ajax提交
												$.post("forummessage.do",{"biaoti":biaoti,"neirong":neirong},function(test){
													var ht=eval("("+test+")");

				...
				<div class="well well-small pull-right user-panel-mini">
					...
					<c:choose>
							<c:when
								...
								<form action="loginforum.do" method="post">
									...
									<ul class="nav nav-pills" style="margin-bottom: 0px">
										<li><a href="register.do" class="xi2 xw1"
								...
								test="${sessionScope.userName!=''||sessionScope.userName!=null}">
										...
										<div>
											<a href="index.do" class="xi2 xw1"
												style="color: #000000; font-size: 14px">返回首页</a>
												
												<a href="forum.do" class="xi2 xw1"
												style="color: #000000; font-size: 14px">返回论坛</a>
										</div>
								</c:when>
								
								<c:otherwise>
									<form action="loginforum.do" method="get">
						<div class="controls controls-row">
							<input class="input-medium" type="text" name="username"
											id="ls_username" class="px vm xg1" placeholder="用户名"
											tabindex="901" /> <input class="input-medium"
			...
			<div class="navbar-inner ">
				<div class="container ">
					...
					<div class="nav-collapse collapse ">
						<ul class="nav ">
							<li class="active " id="mn_forum "><a href="forum.do"
								hidefocus="true " title="BBS ">论坛<span>BBS</span></a></li>
							<li class="active " id="mn_forum "><a href="index.do"
		...
		<div class="title-frame title-frame-big ">
			...
			<div class="container ">
				<div id="chart " class="bm bw0 cl small-bar ">
					...
					<div class="chart z ">
						今日: <em><span style="color: red">${dailyCount}</span></em><span class="pipe ">|</span>昨日: <em><span style="color: red">${previousCount }</span></em><span
							class="pipe ">|</span>帖子: <em><span style="color: red">${meassageCount }</span></em><span class="pipe ">|</span>会员:
						<em><span style="color: red">${usercount}位</span></em>
						|一周内: <em><span style="color: red">${weekcount}</span></em>
						<span class="pipe ">|</span>欢迎新会员: <em><span style="color: red">${newusername} </span></em>
						<span style="color: red;margin-left: 20%">1分钟更新一次</span>
					</div>

...
$(function() {
	...
	<div style="background-color: #6C89B2; margin-top: 0px">
		<div style="margin-left: 90%;">
			...
			<button class="btn btn-primary ladda-button" data-style="expand-left"
				id="zhuce">
				<span class="ladda-label"><a href="zhuce.do"
...
$(document).ready(function(){
	$("#userxinxi").click(function(){
		location.href="User_full_information.do";
...
#search_box #go {
	...
	<div id="menu1" class="menu">
		<ul>
			...
			<li><a href="testshabi.do">动 画</a></li>
			<li><a href="testshabi.do">番 剧</a></li>
			<li><a href="testshabi.do">国 创</a></li>
			<li><a href="testshabi.do">音 乐</a></li>
			<li><a href="#">测 试</a></li>
			<li><a href="xiaoheiwu.do">小 黑 屋</a></li>

...
<body>
	...
	<div id="dialog">
		<p class="close">
			<a href="user_full_information.do" onclick="closeBg();">关闭</a>
		</p>
		<!-- <div>正在加载，请稍后....</div> -->
		<div>
	...
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<!--结束-->
			<div class="dao_list">
				<a href="index.do">首页</a> <a href="javascript:return false;">视频收藏</a> <a href="Shopping.do">周边</a>
		...
		<div class="centers_ml">
			...
			<div class="centers_listm">
				...
				<span class="gjszmdm"> <a href="javascript:showBg();"
					...
					<a href="information.do" class="center_in_self"><font>信息资料</font></a>
					<a href="bank_card.do" class="center_in_self"><font>银行卡管理</font></a>
					<a href="delivery_address.do" class="center_in_self"><font>收货地址管理</font></a>
				</span>
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img
			...
			<div class="public_m1">
				...
				<div class="gezhong_szm">
					...
					<div class="gezhong_szm_in">
						...
						<a href="update_login_password.do">修改密码</a>
					</div>
					<!--一条开始a-->
					<div class="gezhong_szm_in">
						<b
					...
					<div class="gezhong_szm_in">
						...
						<a href="update_paypassword.do">修改密码</a>
					</div>
				</div>
			</div>
</body>
